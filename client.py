...
#Given the path of an request, it will determine the
...
#Both the address and the socket will be passed to this method, so that the thread can
...
#The server will accept incoming connections and spawn a thread
#that will handle the requests for that client.
def main():
